...
public final class Tests
{
  ...
  public static void init(){
    ...
    System.setProperty("pms.repo.jdbc.url",      "jdbc:postgresql:tests");
    System.setProperty("pms.repo.jdbc.user",     "lucien");
    System.setProperty("pms.repo.jdbc.password", "changeit");
